...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonTest(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          SliderTEST(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderDev(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
